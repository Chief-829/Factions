...
public enum FPerm
{
	...
	BUILD(true, "build", "edit the terrain",             Rel.LEADER, Rel.BISHOP, Rel.OFFICER, Rel.MEMBER, Rel.ALLY),
	PAINBUILD(true, "painbuild", "edit, take damage"),
	DOOR(true, "door", "use doors",                      Rel.LEADER, Rel.BISHOP, Rel.OFFICER, Rel.MEMBER, Rel.RECRUIT, Rel.ALLY),
	BUTTON(true, "button", "use stone buttons",          Rel.LEADER, Rel.BISHOP, Rel.OFFICER, Rel.MEMBER, Rel.RECRUIT, Rel.ALLY),
	...
	WITHDRAW(false, "withdraw", "withdraw money",         Rel.LEADER, Rel.BISHOP, Rel.OFFICER),
	TERRITORY(false, "territory", "claim or unclaim",     Rel.LEADER, Rel.BISHOP, Rel.OFFICER),
	ACCESS(false, "access", "grant territory",            Rel.LEADER, Rel.BISHOP, Rel.OFFICER),
	DISBAND(false, "disband", "disband the faction",      Rel.LEADER, Rel.BISHOP),
